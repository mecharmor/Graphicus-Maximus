...
Custom Settings on Jquery Mobile website
Animation Complete.checked = true
jqmData.checked = true
Namespace.checked = true
Support tests.checked = true
Orientation support tests.checked = true
Touch Support test.checked = true
Virtual Mouse.checked = true
Widget Factory.checked = true
Page Creation.checked = true
----Events----
Select All = true
----Forms -----
Range Slider.checked = true
Form Reset.checked = true
Slider.checked = true
Text Input & Text Areas.checked = true
------Navigation -----
Select All.checked = true
-------Transitions ------
Select All.checked = true
-------Utilities--------
Degrade Inputs.checked = true
Match Media Polyfill.checked = true
Zoom Handling.checked = true
------Widgets------
None*
